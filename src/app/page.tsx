  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      {showToast && (
        ...
        >
          <div
            className={`px-6 py-4 rounded-2xl text-white font-medium shadow-2xl border backdrop-blur-sm ${
              toastType === 'success'
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm rounded-full px-6 py-2 shadow-lg border border-slate-200 mb-6">
            ...
            <span className="text-sm font-medium text-slate-700">Internal Tool</span>
          </div>

          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-slate-800 via-indigo-700 to-purple-800 bg-clip-text text-transparent mb-4 tracking-tight">
            OptiMatch
          </h1>
          ...
          <div className="flex items-center space-x-2 md:space-x-6 bg-white/60 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-lg border border-slate-200">
            {steps.map((step, index) => (
              <div key={index} className="flex items-center">
                <div
                  className={`flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full border-2 transition-all duration-500 ${
                    index < currentStep
                      ? 'bg-emerald-500 border-emerald-500 text-white scale-110'
                      : index === currentStep
                      ? 'bg-indigo-500 border-indigo-500 text-white scale-110 animate-pulse'
                ...
                <span
                  className={`hidden md:inline ml-2 text-sm font-medium transition-colors duration-300 ${
                ...
                {index < steps.length - 1 && (
                  <ArrowRight className="w-3 h-3 md:w-4 md:h-4 text-slate-300 mx-2 md:mx-4" />
                )}
              </div>
            ))}
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-slate-800">Source of Truth</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-slate-800">Validation Data</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="flex items-start space-x-4 p-4 bg-blue-50/50 rounded-2xl border border-blue-100">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-sm text-slate-600 truncate">{sourceFile?.name}</p>
                ...
                <div className="flex items-start space-x-4 p-4 bg-amber-50/50 rounded-2xl border border-amber-100">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-sm text-slate-600 truncate">{toValidateFile?.name}</p>
                    <p className="text-xs text-slate-500 mt-1">
        ...
        {isLoading && (
          <div className="max-w-2xl mx-auto mb-12">
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-slate-200 p-8 text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-3">Processing Your Data</h3>
          ...
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200 p-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  <button
                    onClick={handleReset}
                    className="text-red-500 hover:text-red-600 font-medium hover:underline transition-all duration-200 flex items-center gap-2"
                  >
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200 p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-semibold text-slate-800">Match Distribution</h3>
              </div>
        ...
        {!sourceFile && !toValidateFile && !isLoading && (
          <div className="text-center py-16">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-slate-200 p-12 max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                ...
                <div className="p-4 bg-purple-50/50 rounded-xl border border-purple-100">
                  ...
                  <h4 className="font-semibold text-slate-800 mb-2">Intelligent Processing</h4>
                  <p className="text-sm text-slate-600">Advanced algorithms for accurate matching</p>
                </div>
                ...
                <div className="p-4 bg-emerald-50/50 rounded-xl border border-emerald-100">
                  ...
                  <h4 className="font-semibold text-slate-800 mb-2">Rich Analytics</h4>
                  <p className="text-sm text-slate-600">Comprehensive reports and insights</p>
                </div>
              </div>
            </div>
          </div>
